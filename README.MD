...
[Try the live playground](https://image-marker.corerobin.com/playground/) to compose visible layers or embed and verify an invisible trace ID entirely in your browser. Images stay local.
