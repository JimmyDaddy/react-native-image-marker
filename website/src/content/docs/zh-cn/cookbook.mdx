...
<div class="cookbook-grid">
  <figure class="cookbook-card">
    <img src="/media/sample1.webp" alt="瀑布照片底部附近放置了一层文字水印" width="754" height="1116" loading="lazy" decoding="async" />
    <figcaption>带有颜色、样式和锚点定位的文字图层</figcaption>
  </figure>
  <figure class="cookbook-card">
    <img src="/media/imagewatermark.webp" alt="彩色背景上放置了一层图片水印" width="1179" height="900" loading="lazy" decoding="async" />
    <figcaption>缩放后定位于背景之上的图片图层</figcaption>
  </figure>
  <figure class="cookbook-card">
    <img src="/media/multipletexts.webp" alt="多个样式各自独立的文字水印" width="1176" height="910" loading="lazy" decoding="async" />
    <figcaption>多个拥有独立样式的文字图层</figcaption>
  </figure>
  <figure class="cookbook-card">
    <img src="/media/rotateimageicon.webp" alt="背景上放置了一层旋转后的图片水印" width="1179" height="913" loading="lazy" decoding="async" />
    <figcaption>旋转后的图片图层</figcaption>
  </figure>
  <figure class="cookbook-card">
    <img src="/media/watermark-tiled.webp" alt="山间湖泊上错行平铺了带描边的 CONFIDENTIAL 文字" width="1200" height="751" loading="lazy" decoding="async" />
