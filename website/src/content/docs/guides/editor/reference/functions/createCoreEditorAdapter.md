...
Defined in: [packages/editor/src/core-adapter.ts:17](https://github.com/JimmyDaddy/react-native-image-marker/blob/master/packages/editor/src/core-adapter.ts#L17)
