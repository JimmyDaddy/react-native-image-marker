...
description: Install and integrate react-native-image-marker-editor 0.0.1 on top of Core 2.
---

`react-native-image-marker-editor` is a separate, optional JS/TS package. Its
first release is `0.0.1`, and it requires `react-native-image-marker@^2.0.0`.
...
The [live Playground](/playground/#editor-playground) uses the actual Editor
...
and choose **Editor 0.0.1**. It renders `ImageMarkerEditor` and
